...
const initPayment = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield payment_service_1.paymentServices.initPayment(payload);
...
const getAllPayment = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const query = req === null || req === void 0 ? void 0 : req.query;
    const result = yield payment_service_1.paymentServices.getAllPayment(query);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
        statusCode: 200,
