...
const QueryBuilder_constant_1 = require("./QueryBuilder.constant");
class QueryBuilder {
    ...
    filter() {
        ...
        QueryBuilder_constant_1.excludingFields.forEach((x) => delete filter[x]);
    ...
    build() {
        return this === null || this === void 0 ? void 0 : this.modelQuery;
    }
    getMeta() {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return { totalData: totalDocuments, page, limit, totalPage };
        });
    }
}
